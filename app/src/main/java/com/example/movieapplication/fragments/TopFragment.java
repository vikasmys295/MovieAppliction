...
import com.example.movieapplication.adapters.TopMovieAdapter;
...
public class TopFragment extends Fragment {
    ...
    List<TopMovie> movieList = new ArrayList<>();
    RecyclerView recyclerView;
    TopMovieAdapter topMovieAdapter;
    RequestQueue requestQueue;
    String url ="https://api.themoviedb.org/3/discover/tv?api_key=c2e0d1ac159c856cd8e448bab8a71c68&language=en-US&sort_by=popularity.desc&page=1";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        topMovieAdapter = new TopMovieAdapter(movieList,getContext());
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                    ...
                    for(int i= 0;i<jsonArray.length();i++){
                        ...
                        String name = dataResults.getString("name");
                        String poster = dataResults.getString("poster_path");
                        TopMovie movieResults = new TopMovie();
                        movieResults.setName(name);
